<template>
  <Dropdown ref="dropdown" class="text-sm" :items="periodOptions" right>
    ...
    >
      <div
        class="text-sm flex focus:outline-none hover:text-teal-700 dark:hover:text-teal-300 focus:text-teal-700 dark:focus:text-teal-300 items-center py-1 rounded-md leading-relaxed cursor-pointer font-medium"
        :class="
          !value
